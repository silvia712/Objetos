	...
	//Una forma rapida para crearlos es desde la pesta�a SOURCE (generate constructor using Fields...)
	...
	//5-GENERAMOS TO STRING para mostrar los datos (tambien desde SOURCE). Siempre ir� la final.
